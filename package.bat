...
powershell -Command "Compress-Archive -Path 'manifest.json', 'content.js', 'page-audio-bridge.js', 'styles.css', 'popup.html', 'popup.js', 'popup.css', 'shared', 'icons', '_locales' -DestinationPath 'extension.zip' -Force"
